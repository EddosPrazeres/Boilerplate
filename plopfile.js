...
module.exports = plop => {
  ...
  plop.setGenerator("Component", {
    ...
    actions: data => {
      ...
      let componentTemplateStyles = "./__templates__/common/styles.js.hbs";
      let pathStylesSass = "src/components/{{pascalCase name}}/styles.scss";
      let componentTemplateStylesSass =
        "./__templates__/common/styles.scss.hbs";
      ...
      const actions = [
        ...
        },
        {
          type: "add",
          path: pathStylesSass,
          templateFile: componentTemplateStylesSass
        },
        {
          type: "modify",
          path: pathIndex,
